...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2024 at 05:42 PM
...
CREATE TABLE `dsmanager` (
  `managerempID` int(6) UNSIGNED NOT NULL,
...
INSERT INTO `dsmanager` (`managerempID`, `manID`) VALUES
(1, 5),
(8, 1),
(11, 2),
(12, 4),
...
--
ALTER TABLE `dsmanager`
  ADD CONSTRAINT `managed employee` FOREIGN KEY (`managerempID`) REFERENCES `dsemployee` (`empID`);
COMMIT;

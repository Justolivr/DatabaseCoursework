...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2024 at 12:09 PM
...
INSERT INTO `dscar` (`regNo`, `brand`, `model`, `yearMade`, `price`, `customerID`) VALUES
('2222222', 'TEST BRAND', 'TEST MODEL', 1900, 120000, 17),
('4444444', 'tvr', 'tv', 2322, 120000, 18),
...
('OP344OP', 'Renault', 'Clio V6', 2003, 20000, NULL),
...
('YO414AG', 'Ferrari', '599XX', 2010, 5900000, 14);
...
INSERT INTO `dscustomer` (`customerID`, `address`, `postcode`, `firstname`, `lastname`, `phoneNo`) VALUES
...
(14, '12 Bing-Bong Lane', 'PO43 YZ', 'Oliver', 'Racey', '2147483647'),
(17, '12-TESTY LANE', 'YV44TPZ', 'Tony', 'Soprano', '1023'),
(18, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(19, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(20, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(21, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(22, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(23, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(24, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(25, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(26, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(27, '123 BingBong Lane', 'EH14 4A', 'Euan', '', '4059309'),
(28, '13-God Street', 'YEK4505', 'Jerma', '985', '07412772245');
...
(16, 'Euan', 'Grierson', '0003-02-02', 'M', 45, 'pw1', NULL);
...
(5, 7, 8, 'YF05DQR', 14120),
(6, 1, 8, 'DC09YZQ', 10350),
(7, 14, 5, 'YO414AG', 6000000),
(8, 14, 8, 'YO414AG', 6000000),
(9, 17, 9, '2222222', 120000),
(10, 18, 12, '4444444', 1222222),
(11, 18, 12, '4444444', 1222222),
(12, 18, 6, '4444444', 1222222),
(13, 18, 9, '4444444', 1222222),
(14, 18, 1, '4444444', 1222222),
(15, 18, 7, '4444444', 1222222),
(16, 18, 1, '4444444', 1222222),
(17, 18, 6, '4444444', 1222222),
(18, 18, 7, '4444444', 1222222),
(19, 18, 11, '4444444', 1222222),
(20, 28, 8, 'WH04KML', 100000000);
...
(32, 12, 'OP344OP', '0001-12-12', '0002-11-11', 'car'),
(33, 10, 'OP344OP', '0021-02-12', '2222-03-12', 'car broke');
...
--
ALTER TABLE `dscustomer`
  MODIFY `customerID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `dsemployee`
--
ALTER TABLE `dsemployee`
  MODIFY `empID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `dsorder`
  MODIFY `orderID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `dsservice`
--
ALTER TABLE `dsservice`
  MODIFY `serviceID` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
